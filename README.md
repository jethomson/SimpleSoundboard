create_soundboard.py will take a folder of mp3 and/or wav files convert them to base64 data URLs and output a webpage of buttons that will play the audio files.
